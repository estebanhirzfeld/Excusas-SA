...
@DisplayName("Transiciones de Estado de Ánimo")
class TransicionEstadoTest {
    ...
    void menosDe5EsProductivx() {
        // Procesar 3 excusas
        for (int i = 0; i < 3; i++) {
            responsable.evaluarEnCadena(new Excusa(empleado, new MotivoDormido()));
        }
    ...
    // --- Helpers que simulan las transiciones ---
