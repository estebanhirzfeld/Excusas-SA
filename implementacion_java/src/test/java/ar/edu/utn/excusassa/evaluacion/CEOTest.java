...
class CEOTest {
    ...
    @Test
    @DisplayName("envía email al empleado con 'Aprobado por creatividad'")
    void enviaEmailAlEmpleado() {
        Excusa excusa = new Excusa(empleado, new Inverosimil());
        ...
        verify(emailSender).enviarEmail(
            eq("pedro@mail.com"),
            eq("jefe@excusassa.com"),
            contains("Aprobado por creatividad"),
            contains("aprobada por creatividad")
        );
    }
